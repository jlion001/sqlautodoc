...
<html>
	<head>
		<title>VIEW: <xsl:value-of select="schema/view/@name" /></title>
		<style type="text/css">
...
<div class="Header1">VIEW: <xsl:value-of select="schema/view/@name" /></div>
...
<xsl:for-each select="schema/view/columns/column">
	<tr>
...
<pre class="SQLBody">
<xsl:value-of select="schema/view/definition" />
</pre>
</body>
</html>
