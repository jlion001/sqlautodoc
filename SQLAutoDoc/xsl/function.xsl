...
<html>
	<head>
		<title>FUNCTION: <xsl:value-of select="schema/function/@name" /></title>
		<style type="text/css">
...
<div class="Header1">FUNCTION: <xsl:value-of select="schema/function/@name" /></div>
...
<xsl:for-each select="schema/function/parameters/column">
	<tr>
...
<pre class="SQLBody">
<xsl:value-of select="schema/function/definition" />
</pre>
</body>
</html>
